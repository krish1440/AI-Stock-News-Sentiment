...
class NewsScraper:
    ...
    def __init__(self):
        ...
        self.newsapi: Optional[NewsApiClient] = (
    ...
    def fetch_via_newsapi(self, query: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            response = self.newsapi.get_everything(
                q=query, language="en", sort_by="publishedAt", from_param=from_date
            )
    ...
    def fetch_via_yfinance(self, ticker: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for art in news:
                ...
                pub_date = (
                    datetime.fromtimestamp(raw_date)
    ...
    def scrape_all(self, company_name: str, ticker: str) -> List[Dict[str, Any]]:
        ...
        # Deduplicate by URL
        unique_articles = {
            art["url"]: art for art in all_articles if art.get("url")
        }.values()
